...
问黄历 <- function(阳历日期) {
  ...
  黄道吉日 <- c(
    黄历日期, 黄道吉日[3], 黄道吉日[5], 农历月份, 干支年, 黄道吉日[6], 宜[1], 
    '宜', 宜[2], 黄道吉日[-c(1:7, grep('忌', 黄道吉日):length(黄道吉日))], 
    '忌', 忌, 黄道吉日[c((grep('忌', 黄道吉日) + 1):length(黄道吉日))])
  
  黄道吉日甲 <- tibble(
    宜忌 = c(rep('宜', (grep('忌', 黄道吉日) - 1 - grep('宜', 黄道吉日))), 
  ...
  names(黄道吉日甲) <- c(
    '阳历日期', '周日', '生肖年', '农历月日', '干支年', '干支月', '干支日', 
    '宜忌', '黄历')
  
  黄道吉日乙 <- c(
    '生肖', '星座', '彭祖百忌', '胎神占方', '年五行', '季节', '月五行', '星宿', 
    '日五行', '节气', '儒略日', '伊斯兰历', '冲', '煞', '六曜', '十二神')
  ...
  rm(天干, 地支, 万年历, 黄历甲, 黄历乙, 黄历日期, 黄道吉日甲, 黄道吉日乙, 
     干支年, 农历月份, 宜, 忌)
