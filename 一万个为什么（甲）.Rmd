...
集 <- ldply(万, function(迭) {
  ...
  if(!exist('./诸子百家学府/4Dmoon')) dir.create('./诸子百家学府/4Dmoon')
  fwrite(表, paste0('./诸子百家学府/4Dmoon/秦人牧马开彩数据_', 迭, '.csv'))
  }) %>% 
  as_tibble()
```
...
## 检验诸子百家学府书库。
if(!exists('./诸子百家学府/4Dmoon')) dir.create('./诸子百家学府/4Dmoon')
if(!exists('./诸子百家学府/4dresult88')) dir.create('./诸子百家学府/4dresult88')

if (!exists('秦人牧马开彩数据')) 秦人牧马开彩数据 <- readRDS(paste0(.蜀道, '诸子百家学府/彩种/马来西亚彩券数据.rds'))
