...
秦人牧马，愚生尚编写中的个人简历主页[操作系统与程序包](#操作系统与程序包)中只使用并保留咱们祖籍的语言习俗文化宗教语言法律法则，也就是东亚和欧洲，而非本土巫文、爪哇文和赤印度人。借鉴《硅谷传奇》史，咱们高频量化对冲学术份子科学科技核武器，歼灭所有敌人铲单卡款的东南亚与南亚世袭制可兰经法家回教徒和兴都教徒、金宝博、立方有限公司（Cube Ltd）、客世博社团（Caspo Inc）。
...
儒略历系列 <- V8()
公历系列$source('诸子百家学府/Julian_c.js')
jscode <- ctx$call('CoffeeScript.compile', 'square = (x) -> x * x', list(bare = TRUE))
ctx$eval(jscode)
ctx$call('square', 9)
