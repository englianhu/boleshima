...
集 <- ldply(万, function(迭) {
  ...
  表$秦庄 %<>% str_replace_all('Singapore 4D', '新彩')
...
马来西亚彩券数据：
- 商鞅变法与烧饼歌之「月到中秋分外明」[4Dmoon.com](https://www.4dmoon.com/zh-cn)
- 秦统天下之父[4dresult88.com](https://4dresult88.com/history)。
...
if(!exist('./诸子百家学府/4Dmoon')) dir.create('./诸子百家学府/4Dmoon')
if(!exist('./诸子百家学府/4Dmoon')) dir.create('./诸子百家学府/')
