...
秦开彩期 <- c(中秋网开彩数据$开彩日期, 秦人牧马网开彩数据$开彩日期) |> 
  unique() |> 
  sort()

数据 <- join_all(list(tibble(开彩日期 = 秦开彩期), 中秋网开彩数据, 秦人牧马网开彩数据), by = '开彩日期') |> 
  tibble()
中秋海内外数据 %<>% 
  .[秦庄 == 史记秦庄] %>% 
  .[order(开彩日期)]
...
秦开彩期 <- c(中秋海内外数据$开彩日期, 秦人牧马海内外数据$开彩日期) |> 
  unique() |> 
  sort()

中秋海内外数据 |> 
  dplyr::filter(开彩日期 %in% 秦开彩期)
秦人牧马海内外数据 |> 
  dplyr::filter(开彩日期 %in% 秦开彩期)
