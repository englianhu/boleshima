...
由于`forecast`、`fable`系列程序包具有完善的筹算、占卜配套，鉴于[Getting an error "`xreg` and `newxreg` have different numbers of columns"](https://stackoverflow.com/a/37642448/3806250)亦建议用之。
...
集 <- ldply(万[6766:length(万)], function(迭) {
