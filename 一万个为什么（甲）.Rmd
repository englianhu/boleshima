...
集成秦彩册后，开函阅牍/开函阅简。以上海外秦彩庄数据包含`r 海外秦人彩券 <- readRDS(paste0(getwd(), '/诸子百家学府/海外秦人彩券.rds')); paste(unique(海外秦人彩券$秦庄), collapse = '，')`好几家海外秦彩庄。
...
数据甲 <- 椠 %>% 
    str_extract_all('公曆年+(*.+)+function ancient_calendar_description')
