...
程序包 <- c(
  ...
  'plyr', 'dplyr', 'dbplyr', 'dtplyr', 'cnum', 'arabic2kansuji', 'keras', 
  'sarima', 'tidyverse', 'memoise', 'htmltools', 'formattable', 'tidyr', 
  'zoo', 'forecast', 'seasonal', 'magrittr', 'hms', 'seasonalview', 'feather', 
  'rjson', 'rugarch', 'rmgarch', 'mfGARCH', 'tidymodels', 'googleVis', 
  'sparklyr', 'jcolors', 'microbenchmark', 'dendextend', 'tidyverts', 
  'vembedr', 'lhmetools', 'gtools', 'stringi', 'pacman',  'tensorflow', 
  'profmem', 'ggthemes', 'flyingfox', 'highcharter', 'echarts4r', 'rlist',
...
- [公 历 和 农 历 日 期 对 照 (公元前722年—公元2200年)](https://ytliu0.github.io/ChineseCalendar/index_simp.html)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/y5KTlMhh260" title="读《埃隆·马斯克传》：硅谷“钢铁侠”，科学家如何转身成为世界首富？" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
