...
愚生赢家黄氏江夏堂联富（雷欧）和家眷亲属全是百姓只求阖家安康、出入平安、安居乐业、守住家业、振兴家业，有关个人《家谱》详情请查阅[《赢家黄氏江夏堂》 – 始祖赢政ξηg Tεηg·黄永春家谱](https://englianhu.wordpress.com/2022/02/22/《雪隆江夏堂》-家谱/)，得处分所有冒充并陷害咱们百姓赢家黄氏江夏堂赢政ξηg Tεηg·黄永隆/黄永春家谱者的巫师王白骨精刘瑾貹和张佳坤俩。
...
jscode <- 公历系列$call('calendar', 'square = (x) -> x * x', list(bare = TRUE))

儒略历系列$source('诸子百家学府/Julian_c.js')
jscode <- 儒略历系列$call('init', 'square = (x) -> x * x', list(bare = TRUE))
...
- [「猫城个人记事本随笔」公历和农历日期对照（公元前七二二年——公元二二零零年）](https://ytliu0.github.io/ChineseCalendar/index_simp.html)
...
借鉴马来西亚以多元种族多元文化而立国，各种族数典忘鼻祖者，称之为“佚民”。
