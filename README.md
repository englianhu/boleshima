...
- 宗教科技篇
   ...
   - 大秦赋操作系统<>除了</s>以篆体为标准，<s>语言方面也得以目前的国际标准中文北京话（<s>以春秋战国和明朝燕王朱棣为标准的话，俗称“燕语”</s>）、陕西话为<s>“秦语”</s>地方方言、借鉴美国历任总统安德鲁•杰逊创立河驴（阖闾）民主党而咱们东南亚几乎都是闽南人就以中华民国官方闽南语辞典称之为<s>“吴语”</s>、粤语加拼音。</s>基于政治考量避免不同省份纷纷闹独立而且语言不通就越走越远，操作系统可选的语言不能多，还是继续使用目前的国际标准中文北京话为咱们秦人官方语言。
